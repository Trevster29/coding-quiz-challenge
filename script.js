...
function init() {
  ...
  heading.textContent = "Here comes a quiz";

  // creates elements with the instructions for the game
  let instructions = document.createElement("p");
  instructions.setAttribute("id", "instructions");
  instructions.textContent = " 30 seconds each question, penalty for wrong answers"; 
  ...
  startFoodQuiz.setAttribute("id", "startJSQuiz");
  startFoodQuiz.setAttribute("class", "btn btn-secondary");
  startFoodQuiz.textContent= "Not functional";
